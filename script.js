...
const reload = (data) => {
    for (let item of data) {
        ...
        button.onclick = () => {
            ...
            let btn_act = document.querySelectorAll('.button_active')
            zero.innerHTML = btn_act.length
        }
        button.ondblclick = () => {
...
console.log(show_more, show_less);
